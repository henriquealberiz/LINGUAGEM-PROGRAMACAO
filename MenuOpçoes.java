 ...
 */
public class MenuOpçoes extends javax.swing.JFrame {

    /**
     * Creates new form MenuOpçoes
     */
    public MenuOpçoes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        CadastrarLivros.setText("CADASTRO DE LIVROS");
        CadastrarLivros.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CadastrarLivrosActionPerformed(evt);
            }
        });
        getContentPane().add(CadastrarLivros);
        CadastrarLivros.setBounds(100, 90, 170, 40);
        ...
        Voltar.setBounds(130, 230, 120, 40);

        Emprestimo.setText("EMPRÉSTIMOS DE LIVROS");
        ...
        Emprestimo.setBounds(100, 150, 170, 50);
    ...
    private void CadastrarLivrosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CadastrarLivrosActionPerformed
        ...
        TelaCadastro TCA = new TelaCadastro();
    ...
    private void EmprestimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EmprestimoActionPerformed
        TelaPesquisa TPE = new TelaPesquisa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuOpçoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuOpçoes().setVisible(true);
            }
        });
    }
